...
namespace Engine {
	...
	enum DIRECTION {DIR_FORWARD, DIR_BACKWARD, DIR_LEFT, DIR_RIGHT, DIR_UP, DIR_DOWN};
	enum ROTATION {ROT_X,ROT_Y,ROT_Z, ROT_END};

	enum TEXTUREID{TEX_NORMAL, TEX_CUBE, TEX_END};
	enum LAYERID {LAYER_TILE, LAYER_OBJECT, LAYER_PLAYER, LAYER_CAMERA, LAYER_LIGHT, LAYER_UI, LAYER_END};
	enum RENDERID {RENDER_PRIORITY, RENDER_NONALPHA, RENDER_ALPHA, RENDER_UI,RENDER_END};
	
	enum MOUSEKEYSTATE{DIM_LB,DIM_RB,DIM_MB,DIM_END};
	enum MOUSEMOVESTATE{DIMS_X,DIMD_Y,DIMD_Z,DIMS_END};

	enum RAYCHECKTYPE{RAY_AABB, RAY_OBB, RAY_SPHERE, RAY_TRI, RAY_END};
