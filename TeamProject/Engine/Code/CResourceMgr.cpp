...
void CResourceMgr::PreLoad_Font()
{
	...
	m_umFont.insert({ L"프리텐다드", Load_FontBold(L"Pretendard-Bold",L"../..ThirdParty/Pretendard-Bold.ttf", 36) });
	//m_umFont.insert({ L"프리텐다드", Load_Font(L"Pretendard-Regular",L"../..ThirdParty/Pretendard-Regular.ttf", 36) });
	m_umFont.insert({ L"여주", Load_Font(L"YeojuCeramic TTF",L"../..ThirdParty/YeojuCeramic TTF", 36) });
}


ID3DXFont* CResourceMgr::Load_Font(const wstring& key, const wstring& path,_float size)
{
